...
**ConfiMed** is the first parallel English–Arabic benchmark for fine-grained confidentiality classification in healthcare correspondence. The benchmark enables multilingual and cross-lingual evaluation of privacy-aware NLP systems and includes expert annotation guidelines, a manually curated corpus, and reproducible XLM-RoBERTa baselines.
